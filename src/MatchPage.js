...
const MatchesPage = () => {
  ...
  const [newMatch, setNewMatch] = useState({ country_id: '',league_id: '',season: '',stage: '', match_date: '',match_api_id:'', home_team_api_id: '', away_team_api_id: '', home_team_goal: '', away_team_goal: '' });
